...
events=struct('frametime',{},'node',{},'IFS',{},'CWS',{},'timeout',{},'type',{},'status',{},'k',{},'ack',{},'time',{},'Pr',{},'channel',{},'Pt',{},'Gt',{},'Gr',{},'lamda',{},'d',{});
events(1).frametime=3; %distance/speed  
events(1).node=1;
events(1).IFS=0;  %Interframe Space - also used here to define the priority
...
events(1).time=0;
events(1).Pr=0;
events(1).channel=2.4;
events(1).Pt=1; %watt
events(1).Gt=1;

events(1).Gr=1;
events(1).lamda=12.5; %wavelength in cm
events(1).d=60;
